...
<div class="row">
	...
	<button id="review_ads_button" class="btn btn-info">Review add</button>
		<div class="container" style="width:600px; height:200px">
			<iframe sandbox="allow-scripts" width="600" height="200" scrolling="no" frameborder="0" style="overflow:hidden;" src="{{ URL::to('ads/review').'?url=' }}" id="review_ads_iframe"></iframe>
