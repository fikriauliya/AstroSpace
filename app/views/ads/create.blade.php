...
@section('content')
<div class="row">
    {{ Form::open(array('url'=>'ads/publish', 'class'=>'form-horizontal', 'role'=>'form')) }}
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          {{ Form::text('url', null, array('class'=>'form-control', 'placeholder'=>'Url', 'id' => 'review_ads_url')) }}
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-2 control-label" for="budget">Budget</label>
        <div class="col-sm-10">
          {{ Form::text('budget', null,  array('class'=>'form-control', 'placeholder'=>'Budget')) }}
        </div>
      </div>
      <div class="form-group">
